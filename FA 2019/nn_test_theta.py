...
for i in range(1,len(data_straight)):
    ...
    temp.append(((data_straight[i][3]*180/np.pi-data_straight[i-1][3]*180/np.pi)/delta_t)%int(360))
...
for i in range(1,len(data_pos30)):
    ...
    temp.append(((data_pos30[i][3]*180/np.pi-data_pos30[i-1][3]*180/np.pi)/delta_t)%int(360))
...
for i in range(1,len(data_neg30)):
    ...
    temp.append(((data_neg30[i][3]*180/np.pi-data_neg30[i-1][3]*180/np.pi)/delta_t)%int(360))
...
model = TwoLayerNet(len(data[0]),10,10,len(label[0]))
